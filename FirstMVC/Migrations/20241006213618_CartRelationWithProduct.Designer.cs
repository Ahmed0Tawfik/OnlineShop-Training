...
namespace FirstMVC.Migrations
{
    ...
    [Migration("20241006213618_CartRelationWithProduct")]
    partial class CartRelationWithProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstMVC.Models.Cart", b =>
                {
                    b.HasOne("FirstMVC.Models.ApplicationUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("FirstMVC.Models.Cart", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FirstMVC.Models.ApplicationUser", null)
                        .WithMany()
